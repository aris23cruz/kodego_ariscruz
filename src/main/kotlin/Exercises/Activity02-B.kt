...
//Implement Activity 01 -  B using data structure.
    ...
    println("***E-Library***")
    var menu = mapOf(1 to "Barrow",2 to "Return",3 to "Exit")
    var barrow = mutableMapOf(100 to "Generalities",200 to "Philosophy",300 to "Literature",400 to "Technology")
    while (true){
